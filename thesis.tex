\documentclass[12pt,a4paper,oneside,finnish,main=english]{tut-thesis}
% package definitions
\usepackage[backend=biber,bibstyle=authoryear,citestyle=authoryear-comp]{biblatex} % bibliographies
\usepackage[useregional,british]{datetime2}[2016/01/22] % make sure you also have v1.1 or newer of the datetime2-finnish language module
